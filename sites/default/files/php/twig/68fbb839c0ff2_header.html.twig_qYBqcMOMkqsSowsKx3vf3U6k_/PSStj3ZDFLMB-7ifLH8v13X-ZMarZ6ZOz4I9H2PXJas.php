  ...
  <nav>
    ...
    <div id=\"mobile-menu\" class=\"hidden\">
      <div class=\"mobile-menu-content\">
        ";
        // line 59
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "header", [], "any", false, false, true, 59), "html", null, true);
        yield "
        ...
        <div class=\"mobile-actions\">
          ...
          <div id=\"mobile-language-selector\">
            <span id=\"language-selector-content-mobile\">
              ";
        // line 66
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["language"] ?? null), "id", [], "any", false, false, true, 66) == "ar")) {
            // line 67
            yield "                English
              ";
        } else {
        ...
        yield "            </span>
            <div id=\"language-selector\" data-lang=\"";
        // line 72
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["language"] ?? null), "id", [], "any", false, false, true, 72), "html", null, true);
        yield "\">
              <img src=\"";
        // line 73
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (($context["base_path"] ?? null) . ($context["directory"] ?? null)), "html", null, true);
        ...
        yield "\">
          ...
          ";
        // line 77
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["language"] ?? null), "id", [], "any", false, false, true, 77) == "ar")) {
            // line 78
            yield "            <a href=\"";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\Core\Template\TwigExtension']->getUrl("<front>"));
            yield "/node/3\" class=\"partner-button\">
...
";
    ...
    {
        return array (  196 => 86,  188 => 82,  180 => 78,  178 => 77,  169 => 73,  165 => 72,  162 => 71,  158 => 69,  154 => 67,  152 => 66,  142 => 59,  127 => 46,  119 => 42,  111 => 38,  109 => 37,  99 => 32,  96 => 31,  92 => 29,  88 => 27,  86 => 26,  81 => 24,  71 => 17,  59 => 10,  55 => 9,  44 => 1,);
    }
