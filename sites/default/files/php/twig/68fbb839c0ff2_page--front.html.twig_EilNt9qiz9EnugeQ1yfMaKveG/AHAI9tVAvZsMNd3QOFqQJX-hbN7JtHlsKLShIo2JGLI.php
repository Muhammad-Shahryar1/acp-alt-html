...
\t\t";
        // line 10
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "heroVideo", [], "any", false, false, true, 10), "html", null, true);
...
\t\t<div class=\"container relative mx-auto z-10 h-full flex items-end px-8 pb-20\">
  <div class=\"hero-text\">
    <h1 id=\"hero-title\" class=\"opacity-0 translate-y-8 text-4xl sm:text-[51px] font-bold text-white\">
      ";
        // line 15
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "heroheading", [], "any", false, false, true, 15))), "html", null, true);
        yield "
    </h1>
  </div>
</div>
...
\t\t\t\t<div>
\t\t\t\t\t<div class=\"w-full\">
\t\t\t\t\t\t<h1 class=\"text-white text-lg md:text-xl lg:text-2xl font-semibold\" data-i18n=\"content.discoverKingdom\">
\t\t\t\t\t\t\t";
        // line 35
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "heroBoxContent", [], "any", false, false, true, 35), "html", null, true);
        yield "
...
\t\t\t\t\t";
        // line 77
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "aboutHeading", [], "any", false, false, true, 77))), "html", null, true);
        yield "
\t\t\t\t</h2>
...
\t\t\t\t\t";
        // line 82
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "aboutDesc", [], "any", false, false, true, 82))), "html", null, true);
        yield "
\t\t\t\t</p>
\t\t\t</div>
\t\t</div>
...
\t\t\t\t\t\t";
        ...
        // line 104
        yield "\t\t\t\t\t\t<!-- Main Heading -->
\t\t\t\t\t\t<h2 class=\"text-3xl sm:text-[51px] font-bold text-black leading-tight\" data-i18n=\"stats.saudiAirConnectivity\">
\t\t\t\t\t\t\t";
        // line 106
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "statsHeading", [], "any", false, false, true, 106))), "html", null, true);
        yield "
...
\t\t\t\t\t";
        // line 119
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "statsBox1", [], "any", false, false, true, 119));
        yield "
\t\t\t\t\t";
        // line 120
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "statsBox2", [], "any", false, false, true, 120));
        yield "
\t\t\t\t\t";
        // line 121
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "statsBox3", [], "any", false, false, true, 121));
        yield "
\t\t\t\t\t";
        // line 123
        yield "\t\t\t\t</div>
...
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<!-- Title -->
\t\t\t\t\t\t\t<h1 id=\"airportName\" class=\"text-white text-left text-xl font-semibold\">
\t\t\t\t\t\t\t\tAirport Name
\t\t\t\t\t\t\t</h1>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<!-- Divider -->
...
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div id=\"year1\" class=\"w-1/5 text-sm sm:text-base text-center text-white\">
\t\t\t\t\t\t\t\t\t2023
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div id=\"year2\" class=\"ml-2 w-1/5 text-sm sm:text-base text-center text-white\">
\t\t\t\t\t\t\t\t\t2023
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div id=\"intl1\" class=\"w-1/5 text-sm sm:text-base text-center text-white\">
\t\t\t\t\t\t\t\t\t111
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div id=\"intl2\" class=\"ml-2 w-1/5 text-sm sm:text-base text-center text-white\">
\t\t\t\t\t\t\t\t\t111
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div id=\"dom1\" class=\"w-1/5 text-sm sm:text-base text-center text-white\">
\t\t\t\t\t\t\t\t\t111
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div id=\"dom2\" class=\"ml-2 w-1/5 text-sm sm:text-base text-center text-white\">
\t\t\t\t\t\t\t\t\t111
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
...
\t\t\t\t<!-- Right Column - Map -->
\t\t\t\t<div
\t\t\t\t\tclass=\"overflow-hidden min-h-[500px] sm:min-h-[900px] lg:min-h-[730px] col-span-12 lg:col-span-7\">
\t\t\t\t\t<!-- <div
...
\t\t\t\t\t";
        // line 1954
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["language"] ?? null), "id", [], "any", false, false, true, 1954) == "ar")) {
            // line 1955
            yield "\t\t\t\t\t\tالمسارات
\t\t\t\t\t";
        } else {
...
\t\t\t\t\t\t<input type=\"text\" id=\"flight-search\" placeholder=\"";
        // line 1969
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["language"] ?? null), "id", [], "any", false, false, true, 1969) == "ar")) {
...
\t\t\t\t\t\t";
        // line 2020
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["language"] ?? null), "id", [], "any", false, false, true, 2020) == "ar")) {
            // line 2021
            yield "\t\t\t\t\t\t\tاختر قارة
\t\t\t\t\t\t";
        } else {
...
\t\t\t\t\t\t";
        // line 2094
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["language"] ?? null), "id", [], "any", false, false, true, 2094) == "ar")) {
            // line 2095
            yield "\t\t\t\t\t\t\tالأخبار
\t\t\t\t\t\t";
        } else {
...
\t\t\t\t";
        // line 2103
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["language"] ?? null), "id", [], "any", false, false, true, 2103) == "ar")) {
            // line 2104
            yield "                  <a
                    href=\"";
            // line 2105
...
\t\t\t\t\t\t";
        // line 2196
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Twig\Extension\CoreExtension::striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(CoreExtension::getAttribute($this->env, $this->source, ($context["page"] ?? null), "partnerHeading", [], "any", false, false, true, 2196))), "html", null, true);
        yield "
\t\t\t\t\t</h2>
...
\t";
        // line 2240
        yield from $this->loadTemplate("@acp/footer.html.twig", "themes/custom/acp/templates/page--front.html.twig", 2240)->unwrap()->yield($context);
    ...
    {
        return array (  2423 => 2240,  2410 => 2229,  2408 => 2228,  2406 => 2227,  2404 => 2226,  2402 => 2225,  2400 => 2224,  2398 => 2223,  2396 => 2222,  2394 => 2221,  2392 => 2220,  2390 => 2219,  2388 => 2218,  2386 => 2217,  2384 => 2216,  2382 => 2215,  2380 => 2214,  2378 => 2213,  2376 => 2212,  2374 => 2211,  2372 => 2210,  2362 => 2202,  2353 => 2196,  2293 => 2138,  2274 => 2122,  2271 => 2121,  2252 => 2105,  2249 => 2104,  2247 => 2103,  2241 => 2099,  2237 => 2097,  2233 => 2095,  2231 => 2094,  2160 => 2025,  2156 => 2023,  2152 => 2021,  2150 => 2020,  2092 => 1969,  2080 => 1959,  2076 => 1957,  2072 => 1955,  2070 => 1954,  2062 => 1948,  322 => 210,  299 => 190,  281 => 175,  263 => 160,  244 => 144,  227 => 129,  220 => 123,  216 => 121,  212 => 120,  208 => 119,  201 => 114,  199 => 113,  197 => 112,  189 => 106,  185 => 104,  183 => 103,  181 => 102,  179 => 101,  177 => 100,  165 => 89,  156 => 82,  148 => 77,  135 => 66,  121 => 55,  117 => 53,  103 => 42,  99 => 40,  97 => 39,  90 => 35,  76 => 23,  66 => 15,  58 => 10,  55 => 7,  50 => 3,  48 => 2,  44 => 1,);
    }
    ...
    {
        static $tags = ["include" => 2, "if" => 39];
        static $filters = ["escape" => 1, "striptags" => 15, "render" => 15, "raw" => 119];
        static $functions = ["attach_library" => 1, "url" => 42];
